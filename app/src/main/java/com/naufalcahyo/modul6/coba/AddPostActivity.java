package com.naufalcahyo.modul6.coba;
...
import com.naufalcahyo.modul6.coba.model.Post;
import com.naufalcahyo.modul6.coba.model.User;
        ...
        databaseUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (imageUri != null && !TextUtils.isEmpty(name)) {
                    ...
                    Toast.makeText(AddPostActivity.this, "Berhasil di upload", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(AddPostActivity.this, MainActivity.class);
                    startActivity(i);
                } else {
                    //if the value is not given displaying a toast
                    Toast.makeText(AddPostActivity.this, "Silahkan lengkapi terlebih " +
                            "dahulu dan pilih gambar", Toast.LENGTH_LONG).show();
                }
            }
